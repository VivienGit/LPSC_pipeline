...
set_msg_config  -ruleid {67}  -id {Common 17-165}  -string {{ERROR: [Common 17-165] Too many positional options when parsing 'in', please type '::xit::add_dynamic_port -help' for usage info.}}  -suppress 
set_msg_config  -ruleid {68}  -id {IP_Flow 19-1747}  -string {{CRITICAL WARNING: [IP_Flow 19-1747] Failed to deliver file '/opt/Xilinx/Vivado/2017.4/data/ip/xilinx/clk_wiz_v5_4/elaborate/ports.xit': ERROR: [Common 17-165] Too many positional options when parsing 'in', please type '::xit::add_dynamic_port -help' for usage info.}}  -suppress 
set_msg_config  -ruleid {69}  -id {Vivado 12-3523}  -string {{WARNING: [Vivado 12-3523] Attempt to change 'Component_Name' from 'clk_vga_640x480' to 'clk_vga_640x480' is not allowed and is ignored.}}  -suppress 
...
set_msg_config  -ruleid {70}  -id {Vivado 12-3523}  -string {{WARNING: [Vivado 12-3523] Attempt to change 'Component_Name' from 'clk_hdmi_640x480' to 'clk_hdmi_640x480' is not allowed and is ignored.}}  -suppress 
...
set rc [catch {
  ...
  add_files -quiet C:/Users/Vivien/Documents/Master/S2/LPSC/Section11/mse_mandelbrot_no_bram/mse_mandelbrot.runs/synth_1/mse_mandelbrot.dcp
  ...
  read_ip -quiet C:/Users/Vivien/Documents/Master/S2/LPSC/Section11/mse_mandelbrot_no_bram/mse_mandelbrot.srcs/sources_1/ip/blk_mem_bram/blk_mem_bram.xci
...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force mse_mandelbrot_opt.dcp
  create_report "impl_1_opt_report_drc_0" "report_drc -file mse_mandelbrot_drc_opted.rpt -pb mse_mandelbrot_drc_opted.pb -rpx mse_mandelbrot_drc_opted.rpx"
...
set rc [catch {
  ...
  place_design 
  write_checkpoint -force mse_mandelbrot_placed.dcp
  create_report "impl_1_place_report_io_0" "report_io -file mse_mandelbrot_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file mse_mandelbrot_utilization_placed.rpt -pb mse_mandelbrot_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file mse_mandelbrot_control_sets_placed.rpt"
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force mse_mandelbrot_routed.dcp
  create_report "impl_1_route_report_drc_0" "report_drc -file mse_mandelbrot_drc_routed.rpt -pb mse_mandelbrot_drc_routed.pb -rpx mse_mandelbrot_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file mse_mandelbrot_methodology_drc_routed.rpt -pb mse_mandelbrot_methodology_drc_routed.pb -rpx mse_mandelbrot_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file mse_mandelbrot_power_routed.rpt -pb mse_mandelbrot_power_summary_routed.pb -rpx mse_mandelbrot_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file mse_mandelbrot_route_status.rpt -pb mse_mandelbrot_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file mse_mandelbrot_timing_summary_routed.rpt -rpx mse_mandelbrot_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file mse_mandelbrot_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file mse_mandelbrot_clock_utilization_routed.rpt"
  close_msg_db -file route_design.pb
} RESULT]
if {$rc} {
  write_checkpoint -force mse_mandelbrot_routed_error.dcp
...
set rc [catch {
  ...
  catch {write_debug_probes -quiet -force mse_mandelbrot}
  catch {file copy -force mse_mandelbrot.ltx debug_nets.ltx}
